...
<body class="bg-slate-50 text-slate-800 antialiased flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-white shadow-sm h-full flex flex-col z-20 shrink-0">
        ...
        <div class="p-4 border-t border-slate-100 shrink-0">
            <a href="/" class="flex items-center justify-center gap-2 w-full px-4 py-3 rounded-xl font-bold text-rose-500 bg-rose-50 hover:bg-rose-100 transition-colors shadow-sm">
